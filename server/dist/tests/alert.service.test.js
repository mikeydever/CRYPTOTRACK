...
describe('Alert Service', () => {
    ...
    describe('createAlert', () => {
        test('should create a new alert', async () => {
            ...
            prisma.alert.create.mockResolvedValue({ id: 'alert1', ...alertData });
            const result = await (0, alert_service_1.createAlert)(alertData);
    ...
    describe('getAlerts', () => {
        test('should return all alerts for a user', async () => {
            ...
            const result = await (0, alert_service_1.getAlerts)('user123');
    ...
    describe('updateAlert', () => {
        test('should update an alert', async () => {
            ...
            const result = await (0, alert_service_1.updateAlert)('alert1', 'user123', updatedData);
    ...
    describe('deleteAlert', () => {
        test('should delete an alert', async () => {
            prisma.alert.deleteMany.mockResolvedValue({ count: 1 });
            const result = await (0, alert_service_1.deleteAlert)('alert1', 'user123');
