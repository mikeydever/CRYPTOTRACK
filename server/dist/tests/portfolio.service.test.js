...
describe('Portfolio Service', () => {
    describe('calculateAveragePrice', () => {
        test('calculates correct average price with fees', () => {
            ...
            const avgPrice = (0, portfolio_service_1.calculateAveragePrice)(transactions);
        ...
        test('returns 0 for no buy transactions', () => {
            ...
            expect((0, portfolio_service_1.calculateAveragePrice)(transactions)).toBe(0);
        });
    });
    describe('calculateProfitLoss', () => {
        test('calculates correct profit/loss for a single coin', () => {
            ...
            const profitLoss = (0, portfolio_service_1.calculateProfitLoss)(transactions, currentPrice);
    ...
    describe('calculatePortfolioMetrics', () => {
        test('calculates metrics for a single buy', () => {
            ...
            const metrics = (0, portfolio_service_1.calculatePortfolioMetrics)(transactions, currentPrices);
        ...
        test('handles empty transactions array', () => {
            const metrics = (0, portfolio_service_1.calculatePortfolioMetrics)([], {});
            expect(metrics.totalValue).toBe(0);
